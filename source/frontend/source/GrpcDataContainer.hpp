...
public:
    ...
    {
        m_data.insert(m_data.begin() + row, object);
        m_propertyHolders.insert(m_propertyHolders.begin() + row, std::move(bindSettersGetters(object)));
    }

    void addNew(GrpcObject & object)
    {
        m_data.push_back(object);
        m_propertyHolders.push_back(std::move(bindSettersGetters(object)));
    }
    ...
    void removeAll()
    {
        m_data.erase(std::remove(m_data.begin(), m_data.end(), 20), m_data.end());
        m_propertyHolders.erase(std::remove(m_propertyHolders.begin(), m_propertyHolders.end(), 20), m_propertyHolders.end());
    }
