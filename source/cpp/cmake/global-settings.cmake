...
set(ALL_PROJECT_TEST_APPDATA_PATH ${ALL_PROJECT_PATH}/source/cpp/shared/tests/app-data/)
set(ALL_PROJECT_GRPC_PROTOS_PATH ${ALL_PROJECT_PATH}/source/proto/)
set(ALL_PROJECT_GRPC_CPP_SOURCE ${ALL_PROJECT_PATH}/source/cpp/grpc/cpp-source/)
...
set(INCLUDE_DIR ${ALL_PROJECT_PATH}/source/cpp/shared)
...
set(BACKEND_INCLUDE_DIR ${ALL_PROJECT_PATH}/source/cpp/backend/source)
set(BACKEND_THIRD_PARTY_DIR ${BACKEND_INCLUDE_DIR}/3party)
set(BACKEND_GRPC_DIR ${ALL_PROJECT_PATH}/source/cpp/backend/grpc)
...
set(ALL_BACKEND_PROJECT_PATH ${ALL_PROJECT_PATH}/source/cpp/backend/)
...
set(FRONTEND_INCLUDE_DIR ${ALL_PROJECT_PATH}/source/cpp/frontend/source)
set(FRONTEND_THIRD_PARTY_DIR ${FRONTEND_INCLUDE_DIR}/3party)
set(FRONTEND_GRPC_DIR ${ALL_PROJECT_PATH}/source/cpp/frontend/grpc)
...
set(ALL_FRONTEND_PROJECT_PATH ${ALL_PROJECT_PATH}/source/cpp/frontend/)
...
if(WIN32)
        ...
        include_directories(${ALL_PROJECT_PATH}/source/cpp/shared/3party/grpc/build/windows/Debug/include/)
